...
from capstone_addgraph.models.attention import MeanHistoryBlock
...
class TemporalGCNNoAttention(nn.Module):
    def __init__(self, config: AddGraphConfig):
        ...
        self.history_block = MeanHistoryBlock()
    ...
    def step(self, a_hat: torch.Tensor, history: Deque[torch.Tensor]) -> torch.Tensor:
        ...
        short_t = self.history_block(history_tensor)
